...
/* Mike Fechner, Consultingwerk Ltd. 15.03.2016
   Added a fix to an issue in the way the CCID (JSESSIONID) is added to the URL. Progress' JSDO uses an ; as
   delimiter in the URI - which breaks filtering by JSDO (JSESSIONID=....;filter= is not a valid query string)
   replaced ";" with "&" in this line. */
