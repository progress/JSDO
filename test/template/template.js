...
// These are the template suites and tests for people to steal and use! 
// I've added as many possible scenarios as I could possibly think of

describe('-- PUT THE BUG NAME HERE ----', () => {

    // INFORMATION IS HERE
    // Put all of the data relevant to your test in this object.
    const options = {    
        ...
        CustName: "SmokeTest3000"
    };

    // Put all of your globals in this let statement, something that is going to be shared across
    // multiple suites (every describe is a test suite)
    let session,
        jsdo;

    // Put all of the logic that you need done BEFORE ALL of the tests here
    // Sometimes you might want to set up a JSDOSession, sometimes you won't.
    // Make sure to call done!
