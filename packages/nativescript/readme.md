...
This package is a client side TypeScript implementation that extends the JSDO for NativeScript. This provides a seamless integration between OpenEdge (Progress Data Object Service) with NativeScript.
